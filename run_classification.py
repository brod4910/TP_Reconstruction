...
# python run_classification.py --lr .001 --resize 224 --cfg-file classification/models/model1.cfg --root-dir data/tp_cifar_avg --train-csv data/csv_files/cifar_train.csv --val-csv data/csv_files/cifar_test.csv